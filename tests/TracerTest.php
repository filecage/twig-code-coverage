<?php
    ...
    class TracerTest extends TestCase {
        ...
        function testExpectsCorrectTracerFunctionNames () {
            ...
            $this->assertSame('__start_coverage_tracer__i_am_a_unique_namespace', $tracer->getTwigFunctionTraceStart()->getName());
            $this->assertSame('__end_coverage_tracer__i_am_a_unique_namespace', $tracer->getTwigFunctionTraceEnd()->getName());
        }
